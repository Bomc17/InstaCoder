    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center" >
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{route('login')}}" novalidate >
                ...
                @if (session('mensaje'))
                    <p class="bg-red-500 text-white my-2 rounded-lg text-base p-2 text-center">{{session('mensaje')}}</p>
                @endif
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember" > <label class="text-gray-500 text-sm">Mantener mi sesión</label>
                </div>


                <input type="submit" value="Crear Cuenta" class="bg-sky-600 hover:bg-sky-700 uppercase font-bold w-full p-3 text-white rounded-lg cursor-pointer">
            </form>
        </div>
    </div>
@endsection